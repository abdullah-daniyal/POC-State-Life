...
const InsuranceByTimeOfDay: React.FC<InsuranceByTimeOfDayProps> = ({ data }) => {
  ...
  const datasets = insuranceTypes.map((insurance, index) => ({
    label: insurance,
    data: timeSlots.map(slot => distribution[insurance][slot]),
    backgroundColor: [
      'rgba(255, 99, 132, 0.8)',
      'rgba(54, 162, 235, 0.8)',
      'rgba(255, 206, 86, 0.8)',
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 transition-all duration-300 hover:shadow-xl">
      <h2 className="text-2xl font-bold text-gray-800 mb-4">Insurance Types by Time of Day</h2>
